...
page.veiwFilter;
	...
	var titleElement = todoList.get(0).element(by.css('h1.ng-binding'));
...
//	callback(null);
	...
	var todoList2 = element.all(by.repeater('md in searchResults.records'));


	var titleElement = todoList2.get(0).element(by.css('h1.ng-binding'));
