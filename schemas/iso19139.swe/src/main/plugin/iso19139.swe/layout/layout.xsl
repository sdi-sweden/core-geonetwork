...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template mode="mode-iso19139.swe" match="*|@*">
    ...
    <xsl:if test="starts-with(name(), 'gml')">
...
-->
  ...
  <xsl:template mode="mode-iso19139"
                match="gml:*[starts-with(name(.), 'gml:TimePeriodTypeGROUP_ELEMENT') and $schema='iso19139.swe']"
                priority="5000"/>
  ...
  -->
  <xsl:template mode="mode-iso19139" match="gts:TM_PeriodDuration|gml:duration[$schema='iso19139.swe']" priority="5000">
  ...
  <xsl:template mode="mode-iso19139" match="gml:beginPosition[$schema='iso19139.swe']|gml:endPosition[$schema='iso19139.swe']|gml:timePosition[$schema='iso19139.swe']"
                priority="5000">
    ...
    <xsl:message>=======> gml:beginPosition[$schema='iso19139.swe']</xsl:message>
