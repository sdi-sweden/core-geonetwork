...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- Copied templates from iso19139, can't delegate as in iso19139 is used http://www.opengis.net/gml for gml namespace -->
  ...
  <!-- Evaluate an expression. This is schema dependant in order to properly
    ...
    -->
  <xsl:template name="evaluate-iso19139.swe">
  ...
  <xsl:template name="evaluate-iso19139.swe-boolean">
    <xsl:param name="base" as="node()"/>
    <xsl:param name="in"/>
