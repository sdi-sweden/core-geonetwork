...
-->
  ...
  -->
  <sch:pattern fpi="[Geodata.se:110c] Information om restriktioner">
    ...
    <sch:rule context="//gmd:identificationInfo">
      ...
      <sch:assert test="count(resourceConstraints_count) > 0 ">[Geodata.se:110c] Information om restriktioner saknas</sch:assert>
    </sch:rule>
