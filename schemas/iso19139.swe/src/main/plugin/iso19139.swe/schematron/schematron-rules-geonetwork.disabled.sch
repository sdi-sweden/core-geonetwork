...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:pattern>
        ...
        <sch:rule context="//gmd:identificationInfo/*/gmd:citation/gmd:CI_Citation/gmd:title/gco:CharacterString">
            <!-- Title -->

            <sch:let name="text" value=". != ''"/>
            <sch:let name="nilReason" value="../@gco:nilReason and not(.)"/>
            <sch:assert test="$text or $nilReason">
                <sch:value-of select="'Title is required'"/>
            </sch:assert>
