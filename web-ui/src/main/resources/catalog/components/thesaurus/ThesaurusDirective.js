       ...
       function($compile, $timeout, $translate,
         ...
         return {
           ...
           link: function(scope, element, attrs) {
             ...
             var findKeywordPosInArray = function(arr, uriKey) {
               var pos = -1;

               $(arr).each(function(i, el) {
                 if (el.props.uri == uriKey) {
                   pos = i;
                 }
               });
            ...
            scope.toggleSelection = function($event) {
              ...
              if ($event.currentTarget.checked) {
                ...
                var result = findKeywordPosInArray(scope.results,
                  this.keyword.props.uri);
                ...
                var result = findKeywordPosInArray(scope.selected,
                  this.keyword.props.uri);

                if (result > -1) {
                  scope.selected.splice(result, 1);
                }
