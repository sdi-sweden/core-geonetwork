...
(function() {
    goog.provide('gn_select_polygon');

    var module = angular.module('gn_select_polygon', [
        'ngeo',
     ...
     */
    module.service('gnSelectPolygon', ['$rootScope',
        function($rootScope) {
            var mInteraction, polygonFeature;
            var options = {
                waitClass: '',
            ...
            var initInteraction = function(map) {
                ...
                mInteraction.on('drawstart',
                    function(evt) {
                        ...
                        /*deregisterFeature = polygonFeature.on('change',
                            function(evt) {
                ...
                mInteraction.on('drawend',
                    function(evt) {
                        //featureOverlay.getSource().addFeature(polygonFeature);
                        //polygonFeature.unByKey(deregisterFeature);

                        $rootScope.$broadcast('selectPolygon', polygonFeature);
                    }, this);
            };

            this.create = function(map, scope) {
                initInteraction(map);
                return mInteraction;
            };
        }]);
